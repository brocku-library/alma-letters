						...
						<tr> 
							<xsl:choose>
								...
								<xsl:when test="$external_id = '01OCUL_CRL' ">
									<p><xsl:call-template name="afn_fr_contact_us" />  <a href="mailto:libraryservices@cunet.carleton.ca"> libraryservices@cunet.carleton.ca</a> | 613-520-2600 x2734</p>
								</xsl:when>			
								...
								<xsl:when test="$external_id = '01OCUL_IT' ">
									...
									<p><xsl:call-template name="afn_fr_contact_us" />  <a href="https://guides.library.ontariotechu.ca/contact"> Coordonnées de l' Université Ontario Tech</a></p>
								</xsl:when>		
					...
					<xsl:otherwise>						
						<tr> 
							<xsl:choose>
								...
								<xsl:when test="$external_id = '01OCUL_CRL' ">
									<p><xsl:call-template name="afn_en_contact_us" />  <a href="mailto:libraryservices@cunet.carleton.ca"> libraryservices@cunet.carleton.ca</a> | 613-520-2600 x2734</p>
								</xsl:when>
								<xsl:when test="$external_id = '01OCUL_LHD' ">
									<p>
								...
								<xsl:when test="$external_id = '01OCUL_IT' ">
									...
									<p><xsl:call-template name="afn_en_contact_us" />  <a href="https://guides.library.ontariotechu.ca/contact"> Ontario Tech Contact Information</a></p>
								</xsl:when>
								<xsl:when test="$external_id = '01OCUL_QU' ">
