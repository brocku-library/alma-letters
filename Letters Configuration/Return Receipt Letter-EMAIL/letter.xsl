...
<xsl:stylesheet version="1.0"
	...
	<!-- START AFN-VERSION 1.11 START Test if it's an EMAIL partner, if so send return letter,
	otherwise we'll terminate -->
	...
	<!-- END AFN-VERSION 1.11 Test if it's an EMAIL partner if so send return letter, otherwise
	we'll terminate -->
			...
			<body>
				...
				<div class="messageArea">
					<div class="messageBody">
						...
						<!-- AFN CODE -->
						<p> @@inform_returned_items@@<xsl:call-template name="AFNOrgName" />. </p>
						...
						<table cellspacing="0" cellpadding="5" border="0">
							<!-- START AFN-VERSION 1.11 removed the <tr> tag (first row) of table
							containing the h tag. Moved to paragraph above-->
								...
								<tr>
									<td>
										<table cellpadding="5" class="listing">
											...
											<xsl:for-each
												select="item_loans/overdue_and_lost_loan_notification_display/item_loan">
												<tr>
													<td>
